...
main (int argc, char **argv)
{
  ...
  strcpy (source, "2607:f018:600:4:7d10:cf7:67fe:90ca");
  ...
  while(1){
    ...
    while(1){
     ...
     fp = open("freevideo.mp4",O_RDONLY);
      ...
      while(1){
      // ICMP data
      strcpy (target, "2607:fb90:1031:ad65::5359:c01");
